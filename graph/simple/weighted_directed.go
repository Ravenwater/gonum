...
// NewWeightedEdge returns a new Edge from the source to the destination node.
...
// SetWeightedEdge adds e, an edge from one node to another. If the nodes do not exist, they are added.
